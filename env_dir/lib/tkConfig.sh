...
# installed.
TK_PREFIX='/media/gpu/easystore/covid-mobility-tool/env_dir'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/media/gpu/easystore/covid-mobility-tool/env_dir'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1568213740388/work/tk8.6.9/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/media/gpu/easystore/covid-mobility-tool/env_dir/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/media/gpu/easystore/covid-mobility-tool/env_dir/include'
...
# compiled.
TK_SRC_DIR='/home/conda/feedstock_root/build_artifacts/tk_1568213740388/work/tk8.6.9'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1568213740388/work/tk8.6.9/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/media/gpu/easystore/covid-mobility-tool/env_dir/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/conda/feedstock_root/build_artifacts/tk_1568213740388/work/tk8.6.9/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/media/gpu/easystore/covid-mobility-tool/env_dir/lib/libtkstub8.6.a'
